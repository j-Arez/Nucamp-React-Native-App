                ...
                >
                    ...
                    <View style={styles.cardRow}>
                        ...
                        <Icon
                            ...
                            type='font-awesome'
                            color='#5637DD'
                            raised reverse onPress={() => shareCampsite(campsite.name, campsite.description,
            ...
            <ScrollView>
                ...
                <Modal
                    ...
                    <View style={styles.modal}>
                        <Rating
                            showRating startingValue={5}
                            imageSize={40} onFinishRating={(rating) => this.setState({ rating: rating })}
                            syle={{ paddingVertical: 10 }} />
                        <Input
